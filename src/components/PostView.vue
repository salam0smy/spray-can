    ...
    <div class="mdl-grid">
      ...
      <div class="mdl-cell">
        ...
        <div class="actions">
          ...
          <a @click.prevent="loadCatImgFromCatsApi" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">
